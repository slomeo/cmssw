#include "SimG4CMS/Muon/interface/DD4hep_MuonSensitiveDetector.h"
...
//#include "SimG4CMS/Muon/interface/DD4hep_MuonME0FrameRotation.h"
...
*/
  ...
  numbering = new MuonSimHitNumberingScheme(detector, muonConstants);
