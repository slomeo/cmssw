...
process.PoolDBOutputService = cms.Service("PoolDBOutputService",
                                          process.CondDB,
                                          toPut = cms.VPSet(cms.PSet(record = cms.string('GeometryFileRcd'), tag = cms.string('XMLFILE_Geometry_106YV4_Extended2026D49_mc')),
                                                            cms.PSet(record = cms.string('IdealGeometryRecord'), tag = cms.string('TKRECO_Geometry_106YV4')),
                                                            cms.PSet(record = cms.string('PGeometricDetExtraRcd'), tag = cms.string('TKExtra_Geometry_106YV4')),
                                                            cms.PSet(record = cms.string('PTrackerParametersRcd'), tag = cms.string('TKParameters_Geometry_106YV4')),
                                                            cms.PSet(record = cms.string('PEcalBarrelRcd'),   tag = cms.string('EBRECO_Geometry_106YV4')),
                                                            cms.PSet(record = cms.string('PHcalRcd'),         tag = cms.string('HCALRECO_Geometry_106YV4')),
                                                            cms.PSet(record = cms.string('HcalParametersRcd'), tag = cms.string('HCALParameters_Geometry_106YV4')),
                                                            cms.PSet(record = cms.string('PHGcalRcd'),         tag = cms.string('HGCALRECO_Geometry_106YV4')),
                                                            cms.PSet(record = cms.string('HGcalParametersRcd'), tag = cms.string('HGCALParameters_Geometry_106YV4')),
                                                            cms.PSet(record = cms.string('PCaloTowerRcd'),    tag = cms.string('CTRECO_Geometry_106YV4')),
                                                            cms.PSet(record = cms.string('PZdcRcd'),          tag = cms.string('ZDCRECO_Geometry_106YV4')),
                                                            cms.PSet(record = cms.string('PCastorRcd'),       tag = cms.string('CASTORRECO_Geometry_106YV4')),
                                                            cms.PSet(record = cms.string('CSCRecoGeometryRcd'), tag = cms.string('CSCRECO_Geometry_106YV4')),
                                                            cms.PSet(record = cms.string('CSCRecoDigiParametersRcd'), tag = cms.string('CSCRECODIGI_Geometry_106YV4')),
                                                            cms.PSet(record = cms.string('DTRecoGeometryRcd'), tag = cms.string('DTRECO_Geometry_106YV4')),
                                                            cms.PSet(record = cms.string('RPCRecoGeometryRcd'), tag = cms.string('RPCRECO_Geometry_106YV4')),
                                                            cms.PSet(record = cms.string('GEMRecoGeometryRcd'), tag = cms.string('GEMRECO_Geometry_106YV4')),
                                                            cms.PSet(record = cms.string('ME0RecoGeometryRcd'), tag = cms.string('ME0RECO_Geometry_106YV4'))
                                                            )
                                          )
